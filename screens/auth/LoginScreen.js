...
const LoginScreen = ({ navigation }) => {
  ...
  myHeaders.append("Access-Control-Allow-Headers", "GET, POST, PUT, DELETE");
  myHeaders.append("Access-Control-Allow-Header", "Content-Type");
    ...
    >
      <ScrollView style={{ flex: 1, width: "100%" }}>
        ...
        <View style={styles.welconeContainer}>
          <View>
            <Text style={styles.welcomeText}>Welcome to BESTIE STORE</Text>
